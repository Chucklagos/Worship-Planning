                                ...
                                <div class="container-xl">
									...
									<div class="table-wrapper">
										<div class="table-title">
											<div class="row">
												<div class="col-sm-6">
													<h3>Inventario Ministerio de Caballeros <b></b></h3>
												</div>
										...
										<table class="table table-striped table-hover ">
											...
											<tbody>
												<tr>
                                             <?php
                                             $query = "SELECT idInventario, descripcion, cantidad, idMinisterio FROM inventario where idMinisterio=5 ORDER BY idMinisterio DESC";
											...
											<td>
								<a style="margin-right:2px" href="borrarInventarioCaballeros.php?idInventario=<?php echo $row['idInventario']?>"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
											</tr>
                                            <?php } ?>
												<td></td>
												<td></td>
