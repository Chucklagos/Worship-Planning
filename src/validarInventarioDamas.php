<?php
  ...
  if(!$resultado) {
    ...
    $query="INSERT INTO logs VALUES(idLog, '$namesession', '$lastnamesession', '$rolsession', 'inventario', 'Registró $cantidad $descripcion en Inventario de Damas', CURDATE(), CURTIME())";
    $resultado = mysqli_query($conexion, $query);
    if(!$resultado) {
      die("Query Failed.");
    }*/
