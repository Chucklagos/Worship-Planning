                    ...
                    <div class="row">
                                ...
                                <div class="container-xl">
									...
									<div class="table-wrapper">
										<div class="table-title">
											<div class="row">
												<div class="col-sm-6">
													<h3>Inventario Ministerio de Jovenes <b></b></h3>
												</div>
                        ...
                        <th>Cantidad</th>
											...
											<tbody>
												<tr>
                                             <?php
                                             $query = "SELECT idInventario, descripcion, cantidad, idMinisterio FROM inventario where idMinisterio=3 ORDER BY idMinisterio DESC";
							...
							<a style="margin-right:2px" href="borrarInventarioJovenes.php?idInventario=<?php echo $row['idInventario']?>"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
											</tr>
                                            <?php } ?>
												<td></td>
												<td></td>
...
<div id="agregarModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="validarInventarioJovenes.php" method="post">
