<?php
  ...
  $query = "INSERT INTO inventario VALUES(idInventario, '$descripcion', '$cantidad', '2', '$identidad')";
  ...
  if(!$resultado) {
    ...
    $query="INSERT INTO logs VALUES(idLog, '$namesession', '$lastnamesession', '$rolsession', 'inventario', 'Registró $cantidad $descripcion en Inventario Infantil', CURDATE(), CURTIME())";
    $resultado = mysqli_query($conexion, $query);
    if(!$resultado) {
      die("Query Failed.");
    }*/
